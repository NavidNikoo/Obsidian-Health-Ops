      ...
      <Section>
        <div className="grid gap-5 md:grid-cols-2">
          {featurePillars.map((pillar, idx) => (
            <Card key={pillar.title} hover className="overflow-hidden">
              <div className="p-7">
      ...
      <Section className="bg-[var(--color-bg-raised)]/50">
        ...
        <div className="mt-10">
          <Link
            ...
            className="group inline-flex items-center gap-2 text-[var(--color-accent)] hover:text-[var(--color-accent-strong)]"
          >
